...
def main():
    ...
    #parser.add_argument('output_', help="This is the merged database file output as an MGF file")
    ...
    # TODO: We need to output an mapping from database entry to scan number in the MGF file
